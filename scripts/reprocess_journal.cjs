...
const journalId = 'f69ba75e-36a8-4c58-ab04-2eb9e62257b6';

console.log("1. Fetching Journal content from prod DB...");
...
console.log("--- Extracted Text to be sent to AI ---");
console.log(fullText.substring(0, 300) + "...(truncated)...");
console.log("Length:", fullText.length, "chars");
console.log("---------------------------------------");

fs.writeFileSync('/home/user/webapp/scripts/extracted_journal.txt', fullText);

console.log("\n2. Getting API Keys and defining prompt...");
...
console.log("3. Calling OpenAI API...");
async function evaluate() {
  ...
  fs.writeFileSync('/home/user/webapp/scripts/evaluation_result.json', content);
  ...
  // 4. Update Database via Wrangler
  console.log("4. Updating Production DB...");
  ...
  console.log("Done! Production DB updated.");
}
