...
const panelPath = path.join(__dirname, '../src/components/admin/AlertHistoryPanel.tsx');
...
import { Refresh, Download, Close } from '@mui/icons-material';
...
console.log("Updated AlertHistoryPanel.tsx");
