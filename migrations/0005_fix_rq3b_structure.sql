...
CREATE TABLE IF NOT EXISTS rq3b_outcomes (
  ...
  -- RD-Chat (Session-level holistic judgement)
  ...
  -- GA-Evidence (Journal evidence judgement)
  ...
  UNIQUE(user_id, week_number, goal_id, focus_item_id)
);

CREATE INDEX IF NOT EXISTS idx_rq3b_user_week_goal ON rq3b_outcomes(user_id, week_number, goal_id);
