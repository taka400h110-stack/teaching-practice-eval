export interface Env {
  ...
  // SLA エイリアス (旧名互換)
  CLEANUP_ALERT_SLA_ACK_WARNING_MINUTES?: string;
  CLEANUP_ALERT_SLA_ACK_CRITICAL_MINUTES?: string;
  CLEANUP_ALERT_SLA_RESOLVE_WARNING_MINUTES?: string;
  CLEANUP_ALERT_SLA_RESOLVE_CRITICAL_MINUTES?: string;
  CLEANUP_ALERT_SLA_RENOTIFY_INTERVAL_MINUTES?: string;
  CLEANUP_ALERT_SLA_MAX_RENOTIFY_COUNT?: string;
  CLEANUP_ALERT_SLA_CHANNELS?: string;
